...
const handleLiveDemoClick = (liveDemoLink) => {
  if (!liveDemoLink || liveDemoLink === '#') {
    Swal.fire({
      ...
      text: 'Live demo untuk proyek ini sedang dalam pengembangan.',
      confirmButtonText: 'Mengerti',
      confirmButtonColor: '#3085d6',
      background: '#030014',
      color: '#ffffff'
...
const ProjectDetails = () => {
  ...
  const getDemoLink = (projectId, projectTitle) => {
    ...
    return demos[projectId] || project?.LiveDemo || "#";
  };
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || 'https://github.com/Mahroos03',
        LiveDemo: getDemoLink(id, selectedProject.Title),
      };
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                <a
                  ...
                  onClick={(e) => !handleLiveDemoClick(project.LiveDemo) && e.preventDefault()}
